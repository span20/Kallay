...
{else}
	...
	<div style="clear: both; text-align: center;">
		<a href="{$theme_dir}/images/scr_1_csapos_n.jpg" rel="clearbox[gallery=game]"><img src="{$theme_dir}/images/scr_1_csapos.jpg"></a> 
		<a href="{$theme_dir}/images/scr_2_csapos_n.jpg" rel="clearbox[gallery=game]"><img src="{$theme_dir}/images/scr_2_csapos.jpg"></a>
	</div>
	<div style="clear: both; text-align: center;">
...
<div style="text-align: center;">
	...
	<a href="Cseppecske_fekete_feher.pdf" target="_blank"><img src="{$theme_dir}/themes/focus/images/csapos/cseppecske.jpg" /></a>
</div>