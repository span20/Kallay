<div id="form_cnt">
	...
	<div id="f_content">
		...
		<table style="clear: both;">
			<tr class="row2">
				<td class="form">{if $form.dirname.required}<span class="error">*</span>{/if}{$form.dirname.label}</td>
				<td>{$form.dirname.html}{if $form.dirname.error}<span class="error">{$form.dirname.error}</span>{/if}</td>
			</tr>
			<tr class="row1">
