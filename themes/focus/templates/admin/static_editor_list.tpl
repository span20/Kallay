		...
		<table>
			...
			{foreach from=$page_data item=data}
				<tr class="{cycle values="row1,row2"}">
					...
					<td class="last">
						<a class="action mod" href="admin.php?p={$self}&amp;act={$this_page}&amp;sub_act=mod&amp;filename={$data.filename}&amp;field={$smarty.get.field}&amp;ord={$smarty.get.ord}&amp;pageID={$page_id}" title="{$locale.admin_contents.news_tpl_list_modify}"></a>
					</td>
				</tr>
			{foreachelse}
				<tr>
