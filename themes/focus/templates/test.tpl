{if $topli}
	<div>
		...
		{assign var="count_top" value="1"}
		{foreach from=$topli item=data}
			<tr>
				<td>{$count_top}.</td>
				<td>{$data.name}</td>
				<td>{$data.result}</td>
			...
			{assign var="count_top" value=$count_top+1}
		{/foreach}
		</table>
	</div>
{else}
	{if $smarty.session.teszt_email}
		...
		<div id="teszt_cont">
			...
			<div id="question_4" class="q_cont">
				<div class="question">
					...
					<img src="{$theme_dir}/images/folyamatabra.png" />
				</div>
				<div class="answer">
	...
	for(x=0; x<10; x++) {} 
			...
			<div id="question_8" class="q_cont">
				<div class="question">
					...
					<img src="{$theme_dir}/images/abra.png" />
				</div>
				<div class="answer">
