...
>
	...
	<table cellpadding="2" cellspacing="0">
		<tr>
			<td class="block_header" style="background-color: #006BB6;">
				<?php echo ((is_array($_tmp=$this->_tpl_vars['form_login']['header']['login'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>

			</td>
		</tr>
		<tr><td style="height: 5px;"></td></tr>
		<tr><td class="block"><?php echo $this->_tpl_vars['form_login']['login_name']['label']; ?>
</td></tr>
		<tr><td class="block"><?php echo $this->_tpl_vars['form_login']['login_name']['html']; ?>
</td></tr>
