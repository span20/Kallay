<?php /* Smarty version 2.6.16, created on 2007-11-08 12:50:26
         compiled from admin/classifieds_categories_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'admin/classifieds_categories_list.tpl', 18, false),)), $this); ?>
<div id="table">
...
unset($_smarty_tpl_vars);
 ?>
	<div id="t_content">
		...
		<table>
			<tr>
				<th class="first" colspan="2"><?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_field_category_list_lang']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_field_category_list_name']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_field_category_list_add']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_field_category_list_adddate']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_field_category_list_mod']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_field_category_list_moddate']; ?>
</th>
				<th class="last"><?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_field_category_list_action']; ?>
</th>
			</tr>
...
" style="font-size: 14px; font-weight: bold">
								<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/images/admin/arrow_down.gif" border="0" alt="">
							</a>
						<?php endif; ?>
					</td>
...
" title="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_title_category_inactive']; ?>
"></a>
						<?php else: ?>
							<a class="action inact" href="admin.php?p=<?php echo $this->_tpl_vars['self']; ?>
&amp;act=<?php echo $this->_tpl_vars['this_page']; ?>
&amp;sub_act=act&amp;cid=<?php echo $this->_tpl_vars['data']['cid']; ?>
" title="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_title_category_active']; ?>
"></a>
						<?php endif; ?>
...
" title="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_title_category_modify']; ?>
"></a>
						<a class="action del" href="javascript: if (confirm('<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_confirm_category_del']; ?>
')) document.location.href='admin.php?p=<?php echo $this->_tpl_vars['self']; ?>
&amp;act=<?php echo $this->_tpl_vars['this_page']; ?>
&amp;sub_act=del&amp;cid=<?php echo $this->_tpl_vars['data']['cid']; ?>
';" title="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_title_category_del']; ?>
"></a>
...
" title="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_title_category_subcat']; ?>
"></a>
						<?php endif; ?>
...
" title="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_title_category_wayup']; ?>
"></a>
						<a class="action down" href="admin.php?p=<?php echo $this->_tpl_vars['self']; ?>
&amp;act=<?php echo $this->_tpl_vars['this_page']; ?>
&amp;sub_act=ord&amp;cid=<?php echo $this->_tpl_vars['data']['cid']; ?>
&amp;way=down&amp;par=<?php echo $this->_tpl_vars['data']['cparent']; ?>
" title="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_title_category_waydown']; ?>
"></a>
					</td>
				</tr>
			...
			<?php endforeach; else: ?>
				<tr>
					<td colspan="8" class="empty">
						<img src="<?php echo $this->_tpl_vars['theme_dir']; ?>
/images/admin/error.gif" border="0" alt="<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_warning_no_category']; ?>
" />
						<?php echo $this->_tpl_vars['locale']['admin_classifieds']['category_warning_no_category']; ?>
