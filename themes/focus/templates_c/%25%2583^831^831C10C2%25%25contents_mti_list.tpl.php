<?php /* Smarty version 2.6.16, created on 2007-06-25 18:02:23
         compiled from admin/contents_mti_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'admin/contents_mti_list.tpl', 47, false),array('modifier', 'nl2br', 'admin/contents_mti_list.tpl', 49, false),array('modifier', 'escape', 'admin/contents_mti_list.tpl', 49, false),)), $this); ?>
<div id="table">
...
" />
					<?php echo $this->_tpl_vars['locale'][$this->_tpl_vars['self']]['mti_tpl_list_orderby']; ?>

					<select name="field">
						<option value="1" <?php echo $this->_tpl_vars['fieldselect1']; ?>
><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_title']; ?>
</option>
						<option value="2" <?php echo $this->_tpl_vars['fieldselect2']; ?>
><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_section']; ?>
</option>
						<option value="3" <?php echo $this->_tpl_vars['fieldselect3']; ?>
><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_cdate']; ?>
</option>
						<option value="4" <?php echo $this->_tpl_vars['fieldselect4']; ?>
><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_mdate']; ?>
</option>
					</select>
					<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_adminby']; ?>

					<select name="ord">
						<option value="asc" <?php echo $this->_tpl_vars['ordselect1']; ?>
><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_orderasc']; ?>
</option>
						<option value="desc" <?php echo $this->_tpl_vars['ordselect2']; ?>
><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_orderdesc']; ?>
</option>
					</select>
					<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_order']; ?>

					<input type="submit" name="submit" value="<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_submitorder']; ?>
" class="submit_filter" />
				</form>
			</div>
			<?php if ($this->_tpl_vars['category_list']): ?>
			<div style="float: right; padding-right: 5px;">
				<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_filter']; ?>
...
><?php echo $this->_tpl_vars['cats']; ?>
		...
		<table>
			<tr>
				<th class="first"><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_title']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_section']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_cdate']; ?>
</th>
				<th><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_mdate']; ?>
</th>
				<th class="last" style="width: 110px;"><?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_action']; ?>
</th>
			</tr>
...
')">
				...
				<td>
					<?php echo $this->_tpl_vars['data']['category_name']; ?>
...
&amp;ord=<?php echo $_GET['ord']; ?>
&amp;pageID=<?php echo $this->_tpl_vars['page_id']; ?>
" title="<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_active']; ?>
"></a>
					<?php else: ?>
...
&amp;ord=<?php echo $_GET['ord']; ?>
&amp;pageID=<?php echo $this->_tpl_vars['page_id']; ?>
" title="<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_inactive']; ?>
"></a>
					<?php endif; ?>
...
&amp;ord=<?php echo $_GET['ord']; ?>
&amp;pageID=<?php echo $this->_tpl_vars['page_id']; ?>
" title="<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_show']; ?>
"></a>
					<a class="action del" href="javascript: if (confirm('<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_confirm_del']; ?>
...
&amp;ord=<?php echo $_GET['ord']; ?>
&amp;pageID=<?php echo $this->_tpl_vars['page_id']; ?>
';" title="<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_list_delete']; ?>
"></a>
...
/images/admin/error.gif" border="0" alt="<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_warning_no_mtinews']; ?>
" />
					<?php echo $this->_tpl_vars['locale']['admin_contents']['mti_tpl_warning_no_mtinews']; ?>
