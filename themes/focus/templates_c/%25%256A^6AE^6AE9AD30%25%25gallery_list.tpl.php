<?php /* Smarty version 2.6.16, created on 2007-06-19 10:38:11
         compiled from admin/gallery_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'admin/gallery_list.tpl', 30, false),array('modifier', 'escape', 'admin/gallery_list.tpl', 31, false),)), $this); ?>
<div id="table">
...
">
					<td class="first"><a onmouseover="this.T_WIDTH=180;this.T_BGCOLOR='#99ABB9';this.T_FONTCOLOR='#FFFFFF';this.T_BORDERCOLOR='#B9C7D2';return escape('<u><i><?php echo $this->_tpl_vars['locale']['admin_gallery']['list_description']; ?>
...
" title="<?php echo $this->_tpl_vars['locale']['admin_gallery']['list_inactive']; ?>
"></a>
						<?php else: ?>
							<a class="action inact" href="admin.php?p=<?php echo $this->_tpl_vars['self']; ?>
&amp;act=<?php echo $this->_tpl_vars['this_page']; ?>
&amp;sub_act=act&amp;gid=<?php echo $this->_tpl_vars['data']['gid']; ?>
" title="<?php echo $this->_tpl_vars['locale']['admin_gallery']['list_active']; ?>
"></a>
						<?php endif; ?>
						<a class="action mod" href="admin.php?p=<?php echo $this->_tpl_vars['self']; ?>
&amp;act=<?php echo $this->_tpl_vars['this_page']; ?>
&amp;sub_act=gmod&amp;gid=<?php echo $this->_tpl_vars['data']['gid']; ?>
" title="<?php echo $this->_tpl_vars['locale']['admin_gallery']['list_modify']; ?>
"></a>
...
" title="<?php echo $this->_tpl_vars['locale']['admin_gallery']['list_gallery']; ?>
"></a>
						<a class="action del" href="javascript: if (confirm('<?php echo $this->_tpl_vars['locale']['admin_gallery']['confirm_gallery_del']; ?>
')) document.location.href='admin.php?p=<?php echo $this->_tpl_vars['self']; ?>
&amp;act=<?php echo $this->_tpl_vars['this_page']; ?>
&amp;sub_act=gdel&amp;gid=<?php echo $this->_tpl_vars['data']['gid']; ?>
';" title="<?php echo $this->_tpl_vars['locale']['admin_gallery']['list_delete']; ?>
"></a>
					</td>
				</tr>
			<?php endforeach; else: ?>
...
/images/admin/error.gif" border="0" alt="<?php echo $this->_tpl_vars['locale']['admin_gallery']['warning_gallery_empty']; ?>
" />
						<?php echo $this->_tpl_vars['locale']['admin_gallery']['warning_gallery_empty']; ?>
