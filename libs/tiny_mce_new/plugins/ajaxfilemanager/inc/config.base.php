 ...
 */
define('CONFIG_SYS_DEFAULT_PATH',        '../../../../files/tiny_mce/'); //accept relative path only
define('CONFIG_SYS_ROOT_PATH',           '../../../../files/tiny_mce/');	//accept relative path only
define('CONFIG_SYS_FOLDER_SHOWN_ON_TOP', true); //show your folders on the top of list if true or order by name 
define("CONFIG_SYS_DIR_SESSION_PATH",    '../../../../libs/tiny_mce_new/plugins/ajaxfilemanager/session/');
...
define('CONFIG_UPLOAD_MAXSIZE', 15 * 1024 * 1024); //by bytes
...
define('CONFIG_LANG_DEFAULT', (CONFIG_QUERY_STRING_ENABLE && !empty($_GET['language'])?secureFileName($_GET['language']):'hu')); //change it to be your language file base name, such en
?>