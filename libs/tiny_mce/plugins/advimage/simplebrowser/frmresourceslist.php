...
oListManager.AddFile = function( fileName, fileUrl, fileSize )
{
	...
	oCell.noWrap = true ;
	oCell.align = 'right' ;
	oCell.innerHTML = '<b>' + fileName + ':</b>&nbsp;' + fileSize + ' KB, ' + origwidth + 'x' + origheight + ' px<br><input type="button" value="Törlés" onClick="window.open(\'delete.php?file=' + fileUrl + '\', \'Törlés\', \'scrollbars=no, resizable=no,width=300, height=100, toolbar=no, status=no,menubar=no,copyhistory=no\');">';
}
